(this.word = this.word || {}),
  (this.word.bundle = (function (e) {
            ...
            value: function () {
              ...
              this.shadowRoot.appendChild(Sa.content.cloneNode(!0)),
                (this.shadowRoot.querySelector("#hash").textContent =
                  null === (e = window.word) || void 0 === e
                    ? void 0
                    : e.hash),
                (this.shadowRoot.querySelector("#language-button").textContent = window.localStorage.getItem("word-language") == "fr" ? "English" : "Français"),
                ...
                (this.shadowRoot.querySelector("#language-setting").textContent =
                  window.localStorage.getItem("word-language") == "fr" ? "Langue : Français" : "Language: English"),
                (this.shadowRoot.querySelector("#language-button").addEventListener("click", function () {
                    var currentLanguage = window.localStorage.getItem("word-language");
                    window.localStorage.setItem("word-language", currentLanguage == "fr" ? "en" : "fr");
                    saveArchiveNoApp();
    ...
    Ca("config", "G-51PE0HTHXT", {
      app_version:
        null === (Ea = window.word) || void 0 === Ea ? void 0 : Ea.hash,
      debug_mode: !1,
    });
    var La = [
        "cigar",
        ...
        "frame",
        "terry", /* Game 0 */
        "pluet", /* 1 (FEB 10, 2022 - START OF word) */
        "maple", /* 2 (FEB 11) */
        "mails", /* 3 (FEB 12) */
        "boxes", /* 4 (FEB 13) */
        "bobby", /* 5 (FEB 14) */
        ...
        "great", /* 140 (JUN 29) */
        "pucks", /* 141 (JUN 30) */
        "proud"  /* 142 (JUL 1, 2022 - END OF word) */
      ],
      Ta = [    /* DICTIONARY WORDS*/
        "gimli",
        "comox",
    ...
    var Za = "IN_PROGRESS",
      ...
      ts = (function (e) {
        ...
        function t() {
          ...
          if (window.localStorage.getItem("word-language") == null) {
            window.localStorage.setItem("word-language", "en");
          }
          var o = za();
          if (window.localStorage.getItem(archiveDate) == null) {
          ...
          o(t, [
            ...
            },
            {
              ...
              value: function () {
                ...
                (this.shadowRoot.querySelector("#word-title").textContent = 
                  "word ".concat(Ga(new Date(JSON.parse(window.localStorage.getItem(archiveDate)))) - 235)),
  ...
  ***************************************************************************** */
    ...
    var isFrench = window.localStorage.getItem("word-language") == "fr";
    if (isFrench) {
      Cs.innerHTML =
          ...
          o(t, [
            {
              ...
              value: function () {
                ...
                if (window.localStorage.getItem("word-language") == "fr") {
                  twitter.innerHTML = '<p align="center">Découvrez <a href="https://www.twitter.com/wordGame" target="_blank">@wordGame</a> sur Twitter!</p>';  
                } else {
                  twitter.innerHTML = '<p align="center">Check out <a href="https://www.twitter.com/wordGame" target="_blank">@wordGame</a> on Twitter!</p>';
                }
